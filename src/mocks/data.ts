...
export const incidents: Incident[] = [
    {
        ...
        description:
            'Клиент сообщил о повреждении упаковки и содержимого. Коробка была смята, товар внутри разбит.',
        status: 'new',
        priority: 'high',
        reporter: {
            name: 'Алексей Петров',
    ...
    },
    {
        ...
        description:
            'Доставка задержалась из-за поломки автомобиля. Клиент недоволен, требует компенсацию.',
        status: 'in_progress',
        priority: 'medium',
        reporter: {
            name: 'Мария Иванова',
    ...
    },
    {
        ...
        description:
            'Адрес в системе не соответствует фактическому адресу клиента. Требуется уточнение данных.',
        status: 'new',
        priority: 'low',
        reporter: {
    ...
    },
    {
        ...
        description:
            'Клиент отказался получать посылку, сославшись на неправильный товар. Требуется возврат на склад.',
        status: 'resolved',
        priority: 'high',
        reporter: {
            name: 'Елена Козлова',
...
export const comments: Comment[] = [
    {
        ...
        content:
            'Связалась с клиентом, извинилась за задержку. Предложила скидку 10% на следующую доставку.',
